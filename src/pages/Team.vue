...
<template>
  <section class="bg-cyan-950">
    <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
      ...
      <div class="grid mb-6 gap-8 md:grid-cols-2 lg:mb-16">
        <div class="items-center border-gray-700 rounded-lg bg-teal-900 shadow sm:flex">
          <a href="#">
          ...
          <div class="p-5">
            <h3 class="text-xl text-white font-bold tracking-tight">
